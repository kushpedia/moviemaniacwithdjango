"""
Django settings for Kushpedia_E_Shop project.
...
SESSION_EXPIRE_SECONDS = 900  # in seconds
ROOT_URLCONF = 'Kushpedia_E_Shop.urls'
...
WSGI_APPLICATION = 'Kushpedia_E_Shop.wsgi.application'
